 ...
 * @author nacho
 */
public class LoadAverage5Tool implements Tool<Void, Double> {
  @Override
  public String getDescription() {
    return "Returns the average system load in the past 5 minutes";
  }
  ...
  public Double execute(Void unused) {
    return SystemLoad.current().loadAvg5();
  }
}
