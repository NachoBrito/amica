...
import es.nachobrito.amica.agent.localsystem.domain.model.agent.tool.*;
import es.nachobrito.amica.agent.localsystem.infrastructure.InMemoryMessageBus;
import es.nachobrito.amica.agent.localsystem.infrastructure.valkey.SerdeMessageSerializer;
...
class LocalSystemAgentIT {
  ...
  LocalSystemAgentIT() {
    ...
    LocalSystemAgent agent = new LocalSystemAgent(messageBus, toolManager, toolExecutor, memory);
