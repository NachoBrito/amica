...
import static es.nachobrito.amica.agent.conversation.infrastructure.langchain4j.agent.AIAssistantFactory.CHAT_MODEL;
...
public class ConversationAgent implements Agent {
  ...
  private final AgentDetails agentDetails =
      new AgentDetails(
          "conversation-agent", "Conversation Agent (Langchain4J/JLama/%s)".formatted(CHAT_MODEL));
