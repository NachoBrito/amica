...
public class JacksonMessageSerializer implements MessageSerializer {
    ...
    @Override
    public String serializeMessage(ConversationMessage message) {
        try {
    ...
    @Override
    public ConversationMessage deSerializeMessage(String serializedMessage) {
        try {
            return objectMapper.readValue(serializedMessage, ConversationMessage.class);
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
    }
