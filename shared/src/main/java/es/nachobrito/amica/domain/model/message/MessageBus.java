...
///
/// Do not confuse conversationId with response messages. conversationId is a way to keep multiple messages (and their
/// responses) linked in a same context. MessageBus implementations should verify that responses to a message contain
/// the same conversationId that the original one.
